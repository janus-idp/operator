...
func (in *BackstageSpec) DeepCopyInto(out *BackstageSpec) {
	*out = *in
	if in.Backstage != nil {
		...
		*out = new(BackstageSpecBackstage)
		(*in).DeepCopyInto(*out)
	}
	if in.Postgresql != nil {
		in, out := &in.Postgresql, &out.Postgresql
		*out = new(BackstageSpecPostgresql)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackstageSpecBackstage) DeepCopyInto(out *BackstageSpecBackstage) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackstageSpecBackstage.
func (in *BackstageSpecBackstage) DeepCopy() *BackstageSpecBackstage {
	if in == nil {
		return nil
	}
	out := new(BackstageSpecBackstage)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *BackstageSpecPostgresql) DeepCopyInto(out *BackstageSpecPostgresql) {
	*out = *in
	if in.Enabled != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BackstageSpecPostgresql.
func (in *BackstageSpecPostgresql) DeepCopy() *BackstageSpecPostgresql {
	if in == nil {
		return nil
	}
	out := new(BackstageSpecPostgresql)
