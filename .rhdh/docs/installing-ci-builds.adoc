...
# install catalog source and operator subscription, for the latest stable RC or GA
./install-rhdh-catalog-source.sh --latest --install-operator rhdh  

# or, catalog source and operator subscription, for the next CI build based on upstream main branch
